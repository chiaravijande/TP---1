 ...
 *
 * Se leen todos los pokemon válidos del archivo y se almacenan en la pokedex.
 * Si no se pudo leer ningún pokemon válido, se devuelve NULL.
 *
 */
 ...
 *
 * La función se debe invocar con los pokemon ordenados según el criterio de
 * iteracion dado (creciente por nombre o por id).
 *
 * La función de iteración recibe un puntero al pokemon y un puntero al contexto
